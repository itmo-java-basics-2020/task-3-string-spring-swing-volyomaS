...
public class Task3 {
    ...
    int getMaxProduct(int[] inputArray) {
        ...
        if (pmin > 0 || min > 0) return max * pmax;
    ...
    int[][] matrixTranspose(int[][] m) {
        ...
        if (m.length == 0) return new int[2][0];
        if (m[0].length == 0) return new int[2][0];
    ...
    int getStringsStartWithPrefix(String[] inputStrings, String prefix) {
        if (prefix == null || inputStrings == null || inputStrings.length == 0) return 0;
        int count = 0;
